...
public class MsDocPadraoPec01 extends MboValueAdapter {
	...
	public void despacho() throws MXException, RemoteException{
		 ...
		 StringBuilder val = new StringBuilder(); 
		    ...
		    val.append("<p align=\"center\"><strong>&nbsp;</strong></p>");
		    val.append("<p align=\"center\"><strong>XXXXXXXXXXXXXXXXXX</strong></br>");
		    val.append("<p align=\"center\">Coordenador Geral de Análise das Contratações de</br>");
		    val.append("<p align=\"center\">Insumos Estratégicos para Saúde -Substituto</br>");
		    val.append("<p align=\"center\">CGIES/DLOG/SE/MS</br>");
		    val.append("</td>");
		    val.append("</tr>");
		    val.append("</table>");
		    val.append("</body>");
