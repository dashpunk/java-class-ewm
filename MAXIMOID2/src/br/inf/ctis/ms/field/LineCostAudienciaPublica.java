...
public class LineCostAudienciaPublica extends psdi.app.common.purchasing.FldPurLineCost {

	public LineCostAudienciaPublica(MboValue mbv) throws MXException {
		super(mbv);
	}
