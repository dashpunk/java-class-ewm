...
public class AlteraStatusWorkOrderSuspenso implements ActionCustomClass {

	public AlteraStatusWorkOrderSuspenso() {
		super();
	...
	public void applyCustomAction(MboRemote mbo, java.lang.Object[] params)
		...
		mbo1.setValue("STATUS", "SUSPENSO", MboConstants.NOACCESSCHECK);
		MboRemote mbo2;
		...
		for (int i = 0; ((mbo2 = mbo1.getMboSet("WOACTIVITY").getMbo(i)) != null); i++){
			...
			mbo2.setValue("STATUS", "SUSPENSO", MboConstants.NOACCESSCHECK);
		}	
