...
public class CriaUsuarioAtravesNumDoc extends MAXTableDomain {
    ...
    public void validate() throws MXException, RemoteException {
        ...
        //String numDocumento = getMboValue().getString();
        ...
        if (!encontrado) {
            ...
            switch (userInput) {
                ...
                case MXApplicationYesNoCancelException.YES:
                    ...
                    MboSet documentos;
                    documentos = (MboSet) psdi.server.MXServer.getMXServer().getMboSet("BGTBDOCP01", mbo.getUserInfo());
                    ...
                    System.out.println("------------------ cc  antes " + ++aonde);
                    documento.setValue("BGSTCODTIPDOC", mbo.getString("BGSTCODTIPDOC"));
                    System.out.println("------------------ cc  antes " + ++aonde);
                    documento.setValue("BGSTNUMNUMDOC", mbo.getString("BGSTNUMNUMDOC"));
                    ...
                    getMboValue().getMbo().setValue("RHNUFLGSALVO", false);
                    break;
