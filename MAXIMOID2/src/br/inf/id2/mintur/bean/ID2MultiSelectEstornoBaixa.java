 ...
 * @author Patrick
 */
public class ID2MultiSelectEstornoBaixa extends DataBean {

    public ID2MultiSelectEstornoBaixa() {
        super();
        System.out.println("*** ID2MultiSelectEstornoBaixa ***");
    }
    ...
    public synchronized int execute() throws MXException, RemoteException {
        ...
        CustomMboSet destino = (CustomMboSet) app.getDataBean("MAINRECORD").getMbo().getMboSet("MXTBESTLIN");
        ...
        if (origem.getMboSet().getSelection() != null) {
			...
			while (itSelec.hasNext()) {
	            ...
	            if (!existe) {
	                ...
	                System.out.println("*** MXTBTERTRAID da main "+app.getDataBean("MAINRECORD").getMbo().getString("MXTBESTPATID"));
	                
	                mboDestino.setValue("ASSETNUM", item.getString("ASSETNUM"));
	                mboDestino.setValue("MXTBESTPATID", app.getDataBean("MAINRECORD").getMbo().getString("MXTBESTPATID"));
	            }
			}
        }        
