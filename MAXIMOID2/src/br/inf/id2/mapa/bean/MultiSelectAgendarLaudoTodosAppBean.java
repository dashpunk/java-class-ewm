 ...
 */
public class MultiSelectAgendarLaudoTodosAppBean extends MultiselectDataBean {

    public MultiSelectAgendarLaudoTodosAppBean() {
        super();
    }
    ...
    public int selMemos()
        ...
        int i = 0;
        DataBean tableBean = app.getDataBean("memos4");
        ...
        CustomMboSet memoset = (CustomMboSet) app.getDataBean().getMboSet().getMbo().getMboSet("MARL07WOR").getMbo(0).getMboSet("MARL05MEMOS");
        MboRemote memosetWO = app.getDataBean().getMboSet().getMbo().getMboSet("MARL07WOR").getMbo(0);
