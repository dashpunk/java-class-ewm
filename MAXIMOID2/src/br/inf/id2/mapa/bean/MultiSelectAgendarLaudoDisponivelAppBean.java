 ...
 */
public class MultiSelectAgendarLaudoDisponivelAppBean extends MultiselectDataBean {

    public MultiSelectAgendarLaudoDisponivelAppBean() {
        super();
    }
    ...
    public int selMemos()
        ...
        CustomMboSet memoset = (CustomMboSet) app.getDataBean().getMbo().getMboSet("MARL07WOR").getMbo(0).getMboSet("MARL05MEMOS");
