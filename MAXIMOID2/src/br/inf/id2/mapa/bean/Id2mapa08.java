 ...
 *
 */
public class Id2mapa08 extends AppBean {
    ...
    private void validarSalvar() throws MXException, RemoteException {
        ...
        if (getMbo().getBoolean("ID2SEMCON48") == false) {
            ...
            if (!preencimentoObrigatorio((MboSet) getMbo().getMboSet("MARL01IMP")) && getMbo().getString("ID2STAMAP48").equalsIgnoreCase("CONCLUÍDO")) {
                throw new MXApplicationException("id2mapa08", "condProdutoNull");
            }
        }
        super.save();
