 ...
 */
public class MultiSelectTerminoObrasTodosAppBean extends MultiselectDataBean {

    public MultiSelectTerminoObrasTodosAppBean() {
        super();
    }
    ...
    public int selMemos()
        ...
        CustomMboSet memoset = (CustomMboSet) app.getDataBean().getMboSet().getMbo().getMboSet("MARL01WOR").getMbo(0).getMboSet("MARL05MEMOS");
