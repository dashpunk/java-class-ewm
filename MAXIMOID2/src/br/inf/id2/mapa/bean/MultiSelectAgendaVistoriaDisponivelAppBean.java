 ...
 */
public class MultiSelectAgendaVistoriaDisponivelAppBean extends MultiselectDataBean {

    public MultiSelectAgendaVistoriaDisponivelAppBean() {
        super();
    }
    ...
    public int selMemos()
        ...
        CustomMboSet memoset = (CustomMboSet) app.getDataBean().getMbo().getMboSet("MARL05WOR").getMbo(0).getMboSet("MARL05MEMOS");
