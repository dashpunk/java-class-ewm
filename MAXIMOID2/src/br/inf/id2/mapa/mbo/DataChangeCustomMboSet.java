 ...
 */
public class DataChangeCustomMboSet extends psdi.mbo.custapp.CustomMboSet implements DataChangeCustomMboSetRemote {

    public DataChangeCustomMboSet(MboServerInterface mboserverinterface) throws MXException, RemoteException {
