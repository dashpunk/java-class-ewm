 ...
 * @author Patrick
 */
public class CriaOrdemServico implements ActionCustomClass {

    public CriaOrdemServico() {
        super();
        System.out.println("*** ENTROU NO HistoricoMovimentacao()");
    }
...
//        System.out.println("*** após app");
        ...
        System.out.println("*** aonde "+ ++aonde);
        aMbo.setValue("MATBPARATIID", mbo.getString("MATBPARATIID"));
        System.out.println("*** aonde "+ ++aonde);
