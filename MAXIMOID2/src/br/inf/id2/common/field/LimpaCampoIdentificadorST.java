 ...
 *  
 */
public class LimpaCampoIdentificadorST extends MboValueAdapter {

    public LimpaCampoIdentificadorST(MboValue mbv) {
        super(mbv);
    }
    ...
    public void validate() throws MXException, RemoteException {
        ...
        if (getMboValue().getMbo().getString(campoAtual).length() == 0) {
        	...
        	getMboValue().getMbo().setValueNull(nomeProduto + "STCOD" + nomeCampo);
          }
