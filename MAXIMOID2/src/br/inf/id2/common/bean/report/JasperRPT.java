...
public class JasperRPT extends WebClientServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            System.out.println("############### Recuperou Tipo de Relatorio = "+(String)map.get("REPORTTYPE"));
            System.out.println("############### Setou Tipo de Relatorio = "+reporttype);
			...
			if(reporttype == null || reporttype.equals("PDF")){
				...
				geraRTF(reportFile, map, conexao, resp);
    ...
    public void geraRTF(File reportFile, HashMap map, Connection conexao, HttpServletResponse resp) throws JRException, IOException{
        ...
        exporter.setParameter(JRExporterParameter.OUTPUT_FILE, "C:JSP");  
        exporter.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, "Relatorio.rtf");
        exporter.exportReport();
        
        
        bts = rtfReport.toByteArray();  
