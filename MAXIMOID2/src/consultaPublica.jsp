  ...
  <div id="corpo">
    ...
    <div id="conteudo">
      <div id="conteudo-login">
        ...
        <p class="conteudo">
        	<form action="consultaIFrame.jsp" method="post" target="iframe" onSubmit="return validaSubmit();" name="consulta">
        		Código de Barras: <input type="text" class="form-text" style="height:20px" size="55" maxlength="48" name="codigoBarras" /> <input type="button" class="form-button" value="Enviar" onclick="validaSubmit();"/>
        	</form>
        </p>
      </div>
    </div>
		<iframe name="iframe" id="iframe" width="100%" height="500" src="consultaIFrame.jsp" frameborder="0"></iframe>
  </div>
</div>
