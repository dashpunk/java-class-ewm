...
public class ID2AvesTableBean extends psdi.webclient.beans.po.POLineTableBean {

    public ID2AvesTableBean() {
    }
    ...
    public int carregarItens()
        ...
        try {
            int onde = 0;
            //Uteis.espera("Antes--------");
            System.out.println("---------------------------------- Inicio - carregarItens");
            ...
            //TODO VERIFICAR SE � PARA TODOS OS CASOS
            ...
            MboSet itens = (MboSet) parent.getMbo().getMboSet("MAEXP_SALDO");

            if (itens != null) {
                System.out.println("## Total de itens ------------- " + itens.count());
                ...
                for (int i = 0; i < itens.count(); i++) {
                    ...
                    //Uteis.espera("Det. Item-------: " + item.getString("ITEMNUM"));
                    //Uteis.espera("Commodity-------: " + parent.getMbo().getString("COMMODITY"));


                    // if ((item.getString("ITEMNUM").substring(0, 1).equals(parent.getMbo().getString("COMMODITYGROUP"))) && (Validar.marcado((MboSet) parent.getMbo().getMboSet("ID2LISESP"), null, "COMMODITY", item.getString("ITEMNUM").substring(0, 3)))) {
                    if (item.getString("ITEMNUM").substring(0, 1).equals(parent.getMbo().getString("COMMODITYGROUP"))) {
                        ...
                        /*if (parent.getMbo().getString("id2tipolocaldest").equals("02")) {
                        //System.out.println("local destino " + parent.getMbo().getString("ID2DESABA"));
                        linhaAnimal.setValue("STORELOC", parent.getMbo().getString("ID2DESABA"));
                        } else if (parent.getMbo().getString("id2tipolocaldest").equals("03")) {
                        //System.out.println("local destino " + parent.getMbo().getString("ID2DESAGL"));
                        linhaAnimal.setValue("STORELOC", parent.getMbo().getString("ID2DESAGL"));
                        } else if (parent.getMbo().getString("id2tipolocaldest").equals("04")) {
                        //System.out.println("local destino " + parent.getMbo().getString("ID2DESEXP"));
                        linhaAnimal.setValue("STORELOC", parent.getMbo().getString("ID2DESEXP"));
                        }*/
                        //System.out.println("---------------------------------- sets " + ++onde);
                        //Quantidade Emitida
                        linhaAnimal.setValue("ORDERQTY", 0);

                        //Uteis.espera("*************////////-------------- qty = " + linhaAnimal.getString("ORDERQTY"));
                        ...
                        linhaAnimal.setValue("MANUCAVE", item.getString("LOTNUM"));
                        //System.out.println("---------------------------------- sets " + ++onde);
                        ...
                        //linhaAnimal.setValue("STORELOC", parent.getMbo().getString("STORELOC"));
                        ////System.out.println("---------------------------------- APÓS STORELOC DE CARREGAR ITENS ******************************");


                        /*
                        //Código da Exploração
                        linhaAnimal.setValue("STORELOC", parent.getMbo().getString("ID2PROEXP"));
                        /*
                        //System.out.println("---------------------------------- sets");
                        linhaAnimal.setValue("PONUM", parent.getMbo().getString("PONUM"));
                        //System.out.println("---------------------------------- sets " + ++onde);
                        ...
                        //System.out.println("---------------------------------- sets " + ++onde);
                        //Custo
                        //linhaAnimal.setValue("UNITCOST", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("RECEIVEDUNITCOST", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("RECEIVEDTOTALCOST", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("REJECTEDQTY", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("ENTERDATE", new Date());
                        //System.out.println("---------------------------------- sets " + ++onde);
                        ...
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("ISSUE", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("TAXED", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("CHARGESTORE", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("LINECOST", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("TAX1", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("TAX2", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("TAX3", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("RECEIPTREQD", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("TAX4", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("TAX5", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("CATEGORY", "ESTOC");
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("LOADEDCOST", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("PRORATESERVICE", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("RECEIPTSCOMPLETE", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        linhaAnimal.setValue("INSPECTIONREQUIRED", 0);
                        //System.out.println("---------------------------------- sets " + ++onde);
                        ...
                        //System.out.println(String.valueOf(parent.getMbo().getMboSet("POLINE_PROXIMO").getMbo(0).getInt("POLINEID")));
