...
public class ID2FldPerEmail extends psdi.app.person.FldPersonPrimaryEmail
{

	public ID2FldPerEmail(MboValue mbv)
		...
		throws MXException, RemoteException
	{
		...
		if(getMboValue().getString().indexOf("@")>-1)
		{
			...
			throw new MXApplicationException("person", "EmailInvalido", param);
	}
}