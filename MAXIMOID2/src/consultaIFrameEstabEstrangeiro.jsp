...
<body>
	...
	<form name="jasperjasperreportForm" id="jasperjasperreportForm"
		...
		<input type="hidden" name="relatorio"
			value="prod_estab_estrang.jasper"> <input type="hidden"
			name="PAIS" value="<%=pais%>"> <input type="hidden"
				name="AREA" value="<%=area%>"> <input type="hidden"
					name="CATEGORIA" value="<%=categoria%>"> <input
						type="hidden" name="ESPECIE" value="<%=especie%>"> <!--- 			<input type="hidden" name="contentType" value="text/html; charset=UTF-8"> --->
	</form>
